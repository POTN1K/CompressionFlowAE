...
def navier_stokes(_3x3x2, f):
    ...
    def convection(_3x3x2):
        # u                            du/dx                                       v                 du/dy
        return np.array([_3x3x2[1][1][0] * central_difference(_3x3x2[1][0][0], _3x3x2[1][2][0]) + _3x3x2[1][1][
            1] * central_difference(_3x3x2[0][1][0], _3x3x2[2][1][0]),
                         # u                            dv/dx                                       v                 dv/dy
                         _3x3x2[1][1][0] * central_difference(_3x3x2[1][0][1], _3x3x2[1][2][1]) + _3x3x2[1][1][
                             1] * central_difference(_3x3x2[0][1][1], _3x3x2[2][1][1])])

    # diffusion # contains kinetic viscosity, which is not given
    def diffusion_over_kinetic_viscosity(_3x3x2):
        # d^2 u / dx^2                                                d^2 u /dy^2
        return np.array([central_difference_second(_3x3x2[1][0][0], _3x3x2[1][1][0],
                                                   _3x3x2[1][2][0]) + central_difference_second(_3x3x2[0][1][0],
                                                                                                _3x3x2[1][1][0],
                                                                                                _3x3x2[2][1][0]),
                         #                       d^2 v / dx^2                                                d^2 v /dy^2
                         central_difference_second(_3x3x2[1][0][1], _3x3x2[1][1][1],
                                                   _3x3x2[1][2][1]) + central_difference_second(_3x3x2[0][1][1],
                                                                                                _3x3x2[1][1][1],
                                                                                                _3x3x2[2][1][1])])
    ...
    kinetic_viscosity_x = (convection(_3x3x2)[0] - internal_source(_3x3x2)[0] - f[0]) / \
                          diffusion_over_kinetic_viscosity(_3x3x2)[0]
    kinetic_viscosity_y = (convection(_3x3x2)[1] - internal_source(_3x3x2)[1] - f[1]) / \
                          diffusion_over_kinetic_viscosity(_3x3x2)[1]
